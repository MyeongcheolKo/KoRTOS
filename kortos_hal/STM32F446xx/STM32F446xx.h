...
#define CAN_IER_TMEIE_POS		0
#define CAN_IER_TMEIE_MSK		(1 << CAN_IER_TMEIE_POS)
#define CAN_IER_FMPIE0_POS		1
#define CAN_IER_FMPIE0_MSK		(1 << CAN_IER_FMPIE0_POS)
#define CAN_IER_FFIE0_POS		2
#define CAN_IER_FFIE0_MSK		(1 << CAN_IER_FFIE0_POS)
#define CAN_IER_FOVIE0_POS		3
#define CAN_IER_FOVIE0_MSK		(1 << CAN_IER_FOVIE0_POS)
#define CAN_IER_FMPIE1_POS		4
#define CAN_IER_FMPIE1_MSK		(1 << CAN_IER_FMPIE1_POS)
#define CAN_IER_FFIE1_POS		5
#define CAN_IER_FFIE1_MSK		(1 << CAN_IER_FFIE1_POS)
#define CAN_IER_FOVIE1_POS		6
#define CAN_IER_FOVIE1_MSK		(1 << CAN_IER_FOVIE1_POS)
#define CAN_IER_EWGIE_POS		8
#define CAN_IER_EWGIE_MSK		(1 << CAN_IER_EWGIE_POS)
#define CAN_IER_EPVIE_POS		9
#define CAN_IER_EPVIE_MSK		(1 << CAN_IER_EPVIE_POS)
#define CAN_IER_BOFIE_POS		10
#define CAN_IER_BOFIE_MSK		(1 << CAN_IER_BOFIE_POS)
#define CAN_IER_LECIE_POS		11
#define CAN_IER_LECIE_MSK		(1 << CAN_IER_LECIE_POS)
#define CAN_IER_ERRIE_POS		15
#define CAN_IER_ERRIE_MSK		(1 << CAN_IER_ERRIE_POS)
#define CAN_IER_WKUIE_POS		16
#define CAN_IER_WKUIE_MSK		(1 << CAN_IER_WKUIE_POS)
#define CAN_IER_SLKIE_POS		17
#define CAN_IER_SLKIE_MSK		(1 << CAN_IER_SLKIE_POS)
